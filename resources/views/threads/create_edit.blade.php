...
@section('content')
    ...
    <div class="thread_create">
                    ...
                    <div class="reply-box form box-block">
                        ...
                        <div class="form-group">
                            <select class="selectpicker form-control" name="thread[node_id]">
                                <option value=""
                                        disabled {!! $node ?: 'selected'; !!}>{{ trans('hifone.threads.pick_node') }}</option>
                        ...
                        <div class="form-group status-post-submit">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="/markdown" target="_blank"><i class="fa fa-lightbulb-o"></i> Typographic instructions</a>
                                </small>
                            </div>
                        </div>
        ...
        <div class="col-md-3 side-bar">
            ...
            <div class="panel panel-default corner-radius help-box">
                <div class="panel-heading text-center">
                    <h3 class="panel-title">post prompts</h3>
                </div>
                <div class="panel-body">
                    <ul class="list">
                        <li>topic title
                            <p>please describe the title</p>
                        </li>
                        <li>select the node
                            <p>Please select a node for your subject. Appropriate categorization will make your published information more useful.</p>
                        </li>
                        <li>text
                            <p>Hifone stand by <span style="font-family: Consolas, 'Panic Sans', mono"><a
                                            href="https://help.github.com/articles/github-flavored-markdown"
                                            target="_blank">GitHub Flavored Markdown</a></span>
