                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="POST" action="/auth/login">
                            ...
                            <div class="form-group">
                                <input type="login" class="form-control" name="login" value="{{ Input::old('login') }}"
                                       placeholder="{{ trans('hifone.login.login_placeholder') }}">
                            </div>
                            ...
                            <div class="form-group">
                                <input type="submit" name="commit" value="{{ trans('forms.login') }}"
                    ...
                    <ul class="list-group">
                        <li class="list-group-item">
                            @foreach($providers as $provider)
                                <a href="/auth/{{ $provider->slug }}" class="btn btn-default btn-lg btn-block"><i
                                            class="{{ $provider->icon ? $provider->icon : 'fa fa-user' }}"></i> {{ $provider->name }}
                                </a>
                            @endforeach
                        </li>
                    </ul>
