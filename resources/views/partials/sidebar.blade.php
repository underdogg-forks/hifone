    ...
    @if(Auth::check())
        <div class="panel panel-default corner-radius">
            ...
            <div class="panel-body text-center">
                <div class="btn-group">
                    <a href="{!! isset($node) ? URL::route('thread.create', ['node_id' => $node->id]) : URL::route('thread.create') ; !!}"
    ...
    @else
        <div class="panel panel-default corner-radius">
            ...
            <div class="panel-footer text-center">
                已registered用户请 <a href="/auth/login">{{ trans('hifone.login.login') }}</a>
            </div>
        </div>
    @endif
            ...
            <div class="panel panel-default corner-radius">
                ...
                <ul class="list-group">
                    @foreach ($links as $link)
                        <li class="list-group-item"><a href="{{ $link->url }}" rel="nofollow" title="{{ $link->title }}"
                                                       target="_blank"><img src="{{ $link->cover }}"
                                                                            style="width:150px; margin:6px 0;"></a></li>
                    @endforeach
                </ul>
            </div>
        @endif
