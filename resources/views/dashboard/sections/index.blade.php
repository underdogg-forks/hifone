            ...
            <div class="col-sm-12 striped-list" id="item-list" data-item-name="section">
                @forelse($sections as $section)
                    <div class="row striped-list-item" data-item-id="{{ $section->id }}">
                        ...
                        <div class="col-xs-5 text-right">
                            <a href="/dashboard/section/{{ $section->id }}/edit"
                               class="btn btn-default btn-sm">{{ trans('forms.edit') }}</a>
                            <a data-url="/dashboard/section/{{ $section->id }}/delete"
                ...
                @empty
                    <div class="list-group-item"><a
                                href="{{ route('dashboard.section.create') }}">{{ trans('dashboard.sections.add.message') }}</a>
                    </div>
                @endforelse
            </div>
        </div>
